                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">PROPERTY WATCH LISTS</p>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="counter text-primary">{{$property_num}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                <div>
                                    ...
                                    <p class="text-muted">USER WATCH LISTS</p>
                                </div>
                                <div class="ml-auto">
                                    <h2 class="counter text-cyan">{{$cart_num}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    <h2 class="counter text-purple">{{$user_num}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
